...
public class ExercisesAdapter extends RecyclerView.Adapter<ExercisesAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            exerciseName = (TextView) itemView.findViewById(R.id.exercise_name_text);
            exerciseType = (TextView) itemView.findViewById(R.id.exercise_type_text);
            exerciseSet = (TextView) itemView.findViewById(R.id.exercise_set_text);
        }
    }
